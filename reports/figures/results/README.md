...
| **8. Training Dynamics** | [`fig_training_curves_best.png`](fig_training_curves_best.png) | [SVG](fig_training_curves_best.svg) | The best stratified model (F19_r18_b6ainit_randaug_20_v2_s0) smoothly converges to 0.9886 balanced accuracy, showing more stable late-epoch gains than B_none. |
