...
| **8. Training Dynamics** | [`fig_training_curves_best.png`](fig_training_curves_best.png) | [SVG](fig_training_curves_best.svg) | The best stratified model (G6_r18_g2init_randaug_fill200_max20) smoothly converges to 0.9939 balanced accuracy, showing more stable late-epoch gains than B_none. |
